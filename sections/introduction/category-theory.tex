    ...
    \begin{figure}[H]
        \[
            \begin{tikzcd}
              ...
              \end{tikzcd}
        \]
        \caption{Diagram of a product.\textit{For an index set I which factors X into objects $X_i,\; i \in I$ with morphisms $\pi:X\to X_i$ this is a product iff for every object Y and morphisms $f_i:Y\to X_i$ there exists a unique morphism $f:Y\to X$ such that the above diagram commutes}}
        \label{fig:product}
    \end{figure}
