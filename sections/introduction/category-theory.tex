...
\begin{document}
    ...
    \begin{example}
        The category of topological spaces, usually denoted $\mathbf{Top}$, with objects being topological spaces and morphisms being continuous functions. A variant could be to limit spaces to compact such usually referred to as $\mathbf{CTop}$
    \end{example}
