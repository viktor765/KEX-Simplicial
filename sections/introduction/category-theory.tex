...
\begin{document}
    ...
    \begin{figure}[ht!]
        ...
        \begin{subfigure}[b]{0.5\textwidth}
            \centering
            \includegraphics[scale=.7]{Functor_cone}
            \caption{}
        \end{subfigure}%
        ~ 
        \begin{subfigure}[b]{0.5\textwidth}
            \centering
            \includegraphics[scale=.7]{Functor_co-cone}
            \caption{}
        \end{subfigure}
        \caption{Diagrams of a limit and a colimit. Cone and co-cone}
    \end{figure}
    ...
    \begin{figure}[h]
        ...
        \caption{Diagram of product. If Y is some object and for every i in I, $\pi_i:Y\to X_i$ is a morphism, then there exists a unique map $f:Y\to X$ such that for each i in I the diagram commutes.}
        \label{fig:product}
    \end{figure}
