...
\begin{document}
    ...
    Geometric realization, as was mentioned in the example \ref{functor_exmp}, is a functor from $\mathbf{sSet}\to \mathbf{CGHaus}$. This entails that a simplicial set 
    ...
    \begin{example}
        ...
        \end{figure}
        Should all the vertices, endpoints, be identified the diagram realizes as a sphere. On a side note the simplicial complex would have needed additional 2-simplices as they would have need to remain being triangles after the realization to achieve a torus.
    \end{example}
