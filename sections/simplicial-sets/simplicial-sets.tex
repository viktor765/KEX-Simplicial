...
\begin{document}
    ...
    In simple terms the proof gathers from the proof of proposition \ref{is-CW} where the constructed function is used to obtain unique non-degenerate representatives and then establishing a bijection. A complete proof is in \cite{simp-may}. 
